package com.bbdata.server.config;
...
@Configuration
@EnableMongoRepositories("com.bbdata.server.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.bbdata.server.config.dbmigrations");
