...
import com.bbdata.server.BbdataApp;
...
@SpringBootTest(classes = BbdataApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class BbdataKafkaResourceIT {
    ...
    @Autowired
    private BbdataKafkaProducer producer;

    @Autowired
    private BbdataKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        BbdataKafkaResource kafkaResource = new BbdataKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/bbdata-kafka/publish?message=test"))
